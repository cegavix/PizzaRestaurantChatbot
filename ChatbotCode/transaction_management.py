...
def make_booking(user_input, name):
    ...
    while booking_time is None:
        ...
        if booking_time is None:
            print("Papa: I'm sorry, I didn't quite catch the time for your booking. Try specifying the time of day with"
                  "a am or pm.")
    ...
    while table_size is None:
        ...
        if table_size is None:
            print("Papa: I'm sorry, I didn't quite catch the table size needed for your booking. Say a table for 2, "
                  "for example.")
        elif table_size > 5:
...
# make_booking("I'd like to make a booking for 7pm and for 10 people.", 'Constance')
